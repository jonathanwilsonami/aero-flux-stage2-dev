...
def enrich_record(
    ...
    # Project to exactly the dataset schema: drops superseded fields (e.g.
    # canonical's operating_carrier, now split into carrier_icao/iata/name) and
    # guarantees uniform rows.
    return {field: out.get(field) for field in DATASET_FIELDS}
